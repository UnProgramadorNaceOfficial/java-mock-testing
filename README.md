![Descripción alternativa](./MockInit/MockTestingProject/src/main/resources/static/imagen.png)
...
### Comando para la JVM: -ea -XX:+EnableDynamicAgentLoading -Xshare:off
